...
# Load PDF paths
pdf_paths = ['Customer_pitch_3.pdf', 'Customer_pitch.pdf', 'Protect.pdf', 'tax.pdf','Low_risk_portfolio.pdf', 'Medium_risk_portfolio.pdf', 'High_risk_portfolio.pdf', 'pdf_bro_understanding_mfs_p.pdf', 'financial-terms-dictionary-100-most-popular-financial-terms-explained-obooko.pdf']  
