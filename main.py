...
def execute_research_query(chain, question: str):
    """
    Execute a research query with comprehensive error handling
    """
    try:
        # Add detailed logging
        print(f"DEBUG: Executing research query for: {question}")
        
        # Invoke the chain with full error tracing
        ...
        # Check for content attribute or direct string conversion
        ...
        if "API" in str(e):
            return {"output_text": "API connection issue. Please check your API keys and network connection."}
