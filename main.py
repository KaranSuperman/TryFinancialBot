...
def execute_research_query(chain, question: str):
    try:
        ...
        # Retrieve API keys with debug logging
        try:
        ...
        print(f"DEBUG: Retriever initialized: {retriever}")
